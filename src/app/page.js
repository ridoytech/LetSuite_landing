  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-slate-900 overflow-x-hidden">
      ...
      <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
        <nav className="bg-white/30 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_rgb(0,0,0,0.08)] rounded-full px-6 py-3 flex items-center justify-between w-full max-w-6xl">
          <div className="flex items-center gap-2">
            <img src="/Let Suite-Photoroom.png" alt="Let Suite" className="h-10 w-auto object-contain" />
          </div>
      ...
      <a href="https://wa.me/1234567890" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 group flex items-center justify-center">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/10">
              ...
              <span className="text-sm font-semibold text-primary">The Complete Lettings Solution</span>
            </div>
